package src.copy.algorithms;


import src.copy.graph.Digraph;
import src.copy.graph.Edge;
import src.copy.graph.Node;

import java.util.ArrayList;
import java.util.HashMap;

import static src.copy.utils.Functions.print;
import static src.copy.utils.Functions.println;
